...
SCHEDULER_PARAMS = {'type': 'CosineAnnealingLR', 'T_max': 2, 'eta_min': 0}



#OPTIMIZER_PARAMS = {'type': 'Adam', 'lr': 0.0005}
#ORI#OPTIMIZER_PARAMS    = {'type': 'SGD', 'lr': 0.005, 'momentum': 0.9}
#SCHEDULER_PARAMS = {'type': 'StepLR', 'step_size': 5, 'gamma': 0.1}
#ORI#SCHEDULER_PARAMS    = {'type': 'MultiStepLR', 'milestones': [30, 35], 'gamma': 0.2}
